...
#Python program to Form a Calculator
...
# Take Radius from end user and reflect area of circle.
# pi = 3.14
# Area of Circle --> pi*r**2

#Python program to Find Perimter of a Circle

# Take Radius from end user and reflect perimeter of circle.
# pi = 3.14
# Area of Circle --> 2*pi*r

# Python program to Find Perimeter of a Rectangle .

# Take input for length and breadth and refelect
