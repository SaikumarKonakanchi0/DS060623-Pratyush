...
# He has an order of curtains of length of 12 feet. He has to find 
# how many curtains can  be made from these pieces. Length of pieces 
# of cloth is recorded in feet.

# Note : You are expected to write code in the findTotalCurtains 
# function only which receive the first parameter as the number 
# of items in the array and second parameter as the array itself. 
...
# Input
# input 1 : 5
# input 2 : 3 42 60 6 14 ==> 0+3+5+0+1 ==> 9
